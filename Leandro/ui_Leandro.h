...
public:
    ...
    void setupUi(QMainWindow *LeandroClass)
    {
        ...
        QBrush brush16(QColor(74, 74, 74, 255));
        ...
        scrollAreaChannelsWidgetContents_2->setGeometry(QRect(0, 0, 2480, 281));
        ...
        QBrush brush17(QColor(73, 73, 73, 255));
        ...
        effectsScrollAreaContents->setGeometry(QRect(0, 0, 1273, 405));
